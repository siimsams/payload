...
export interface Config {
  ...
  collections: {
    ...
    'custom-filter-test': CustomFilterTest;
    'custom-id': CustomId;
  ...
  collectionsSelect: {
    ...
    'custom-filter-test': CustomFilterTestSelect<false> | CustomFilterTestSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "custom-filter-test".
 */
export interface CustomFilterTest {
  id: string;
  title: string;
  weight?: number | null;
  height?: number | null;
  category?: ('electronics' | 'clothing' | 'books' | 'sports') | null;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'custom-filter-test';
        value: string | CustomFilterTest;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "custom-filter-test_select".
 */
export interface CustomFilterTestSelect<T extends boolean = true> {
  title?: T;
  weight?: T;
  height?: T;
  category?: T;
